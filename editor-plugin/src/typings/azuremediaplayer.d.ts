/**
 * API of Azure Media Player ([[amp]]), use amp.d.ts if caller is using [TypeScript](http://www.typescriptlang.org/).
 */
declare module amp {
    ...
    interface Player {
        ...
        /**
         * Get the playable window start and end in seconds
         *
         * @return Playable window start and end in seconds
         */
        currentPlayableWindow(): Array<number>;

        /**
         * Get the calculated segment boundaries
         *
        ...
        /**
         * Given a player time (player time where 00:00:00 represents the time the player started playback on a live stream),
         * calculates and returns the associated presentation time (the actual stream time where 00:00:00 represents the start of the stream)
        ...
        /**
         * Given a prensentation time (the actual stream time where 00:00:00 represents the start of the stream),
         * calculates and returns the associated player time (player time where 00:00:00 represents the time the player started playback on a live stream)
         * Used in live playback calculations
         *
    ...
    export interface MediaDownload {
        ...
        /**
         * Returns the absolute time for this download in seconds, null, if initialization download
         **/
        absoluteTime: number;
    }
    ...
    export class eventName {
        ...
        /**
         * [[amp.Player.playbackDownloadBitrate]] property has changed.
         */
     ...
     */
    function plugin(name: string, init: Object);

    function AdobePremierProShortcutConfig(): void;
}
