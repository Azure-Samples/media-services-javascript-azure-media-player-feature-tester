...
(function (Microsoft) {
	...
	(function (ApplicationInsights) {
		...
		var _InternalLogMessage = (function () {
			function _InternalLogMessage(msg, properties) {
				this.message = msg;
			...
			Util.getStorage = function (name) {
				...
				if (storage !== null) {
					try {
						...
						var message = new ApplicationInsights._InternalLogMessage("Browser failed read of local storage. " + Util.getExceptionName(e));
			...
			Util.setStorage = function (name, data) {
				...
				if (storage !== null) {
					try {
						...
						var message = new ApplicationInsights._InternalLogMessage("Browser failed write to local storage. " + Util.getExceptionName(e));
						message.properties.exception = Util.dump(e);
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, message);
					}
				}
			...
			Util.removeStorage = function (name) {
				...
				if (storage !== null) {
					try {
						...
						var message = new ApplicationInsights._InternalLogMessage("Browser failed removal of local storage item. " + Util.getExceptionName(e));
						message.properties.exception = Util.dump(e);
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, message);
					}
				}
			...
			Util.getSessionStorage = function (name) {
				...
				if (storage !== null) {
					try {
						...
						var message = new ApplicationInsights._InternalLogMessage("Browser failed read of session storage. " + Util.getExceptionName(e));
						message.properties.exception = Util.dump(e);
			...
			Util.setSessionStorage = function (name, data) {
				...
				if (storage !== null) {
					try {
						...
						var message = new ApplicationInsights._InternalLogMessage("Browser failed write to session storage. " + Util.getExceptionName(e));
						message.properties.exception = Util.dump(e);
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, message);
					}
				}
			...
			Util.removeSessionStorage = function (name) {
				...
				if (storage !== null) {
					try {
						...
						var message = new ApplicationInsights._InternalLogMessage("Browser failed removal of session storage item. " + Util.getExceptionName(e));
						message.properties.exception = Util.dump(e);
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, message);
					}
				}
		...
		var AjaxMonitor = (function () {
			...
			AjaxMonitor.prototype.instrumentOpen = function () {
				...
				XMLHttpRequest.prototype.open = function (method, url, async) {
					try {
						...
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("Failed to monitor XMLHttpRequest.open, monitoring data for this ajax call may be incorrect.", {
			...
			AjaxMonitor.prototype.instrumentSend = function () {
				...
				XMLHttpRequest.prototype.send = function (content) {
					try {
						...
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("Failed to monitor XMLHttpRequest, monitoring data for this ajax call may be incorrect.", {
							ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(this),
							exception: Microsoft.ApplicationInsights.Util.dump(e)
						}));
					}
			...
			AjaxMonitor.prototype.instrumentAbort = function () {
				...
				XMLHttpRequest.prototype.abort = function () {
					try {
						...
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("Failed to monitor XMLHttpRequest.abort, monitoring data for this ajax call may be incorrect.", {
							ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(this),
							exception: Microsoft.ApplicationInsights.Util.dump(e)
						}));
					}
			...
			AjaxMonitor.prototype.attachToOnReadyStateChange = function (xhr) {
				...
				xhr.ajaxData.xhrMonitoringState.onreadystatechangeCallbackAttached = ApplicationInsights.EventHelper.AttachEvent(xhr, "readystatechange", function () {
					try {
						...
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("Failed to monitor XMLHttpRequest 'readystatechange' event handler, monitoring data for this ajax call may be incorrect.", {
			...
			AjaxMonitor.prototype.onAjaxComplete = function (xhr) {
				...
				if (xhr.ajaxData.ajaxTotalDuration < 0) {
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("Failed to calculate the duration of the ajax call, monitoring data for this ajax call won't be sent.", {
						ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(xhr),
	...
	(function (ApplicationInsights) {
		...
		var Serializer = (function () {
			...
			Serializer._serializeObject = function (source, name) {
				...
				var output = {};
				if (!source) {
					ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("cannot serialize object because it is null or undefined", { name: name }));
					return output;
				}
				if (source[circularReferenceCheck]) {
					ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("Circular reference detected while serializing object", { name: name }));
					return output;
				}
				if (!source.aiDataContract) {
					if (name === "measurements") {
						...
						ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("Attempting to serialize an object which does not implement ISerializable", { name: name }));
						try {
				...
				for (var field in source.aiDataContract) {
					...
					if (isRequired && !isPresent && !isArray) {
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("Missing required field specification. The field is required but not present on source", { field: field, name: name }));
						continue;
					}
					if (isHidden) {
						continue;
			...
			Serializer._serializeArray = function (sources, name) {
				...
				if (!!sources) {
					if (!ApplicationInsights.Util.isArray(sources)) {
						ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("This field was specified as an array in the contract but the item is not an array.\r\n", { name: name }));
					}
					else {
						output = [];
			...
			var _SessionManager = (function () {
				...
				_SessionManager.prototype.initializeAutomaticSessionWithData = function (sessionData) {
					...
					try {
						...
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("Error parsing ai_session cookie, session will be reset: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
					}
					if (this.automaticSession.renewalDate == 0) {
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("AI session renewal date is 0, session will be reset."));
					}
				};
				_SessionManager.prototype.renew = function () {
					...
					if (!ApplicationInsights.Util.canUseLocalStorage()) {
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("Browser does not support local storage. Session durations will be inaccurate."));
					}
				};
		...
		(function (Context) {
			...
			var User = (function () {
				...
				User.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
					...
					if (isInvalidInput) {
						ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("Setting auth user context failed. " +
		...
		var DataLossAnalyzer = (function () {
			...
			DataLossAnalyzer.reportLostItems = function () {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("Failed to report data loss: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
				finally {
					try {
		...
		var Sender = (function () {
			...
			Sender.prototype.send = function (envelope) {
				...
				try {
					...
					if (!envelope) {
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("Cannot send empty telemetry"));
						return;
					}
					if (!this._sender) {
						ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("Sender was not initialized"));
						return;
					}
			...
			Sender.prototype.triggerSend = function (async) {
				...
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("Telemetry transmission failed, some telemetry will be lost: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			...
			Sender._onError = function (payload, message, event) {
				ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("Failed to send telemetry.", { message: message }));
			};
					...
					DataSanitizer.sanitizeKey = function (name) {
						if (name) {
							...
							if (name.search(/[^0-9a-zA-Z-._()\/ ]/g) >= 0) {
								...
								ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("name contains illegal characters. Illegal characters have been replaced with '_'.", { newName: name }));
							}
							if (name.length > DataSanitizer.MAX_NAME_LENGTH) {
								name = name.substring(0, DataSanitizer.MAX_NAME_LENGTH);
								ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("name is too long.  It has been truncated to " + DataSanitizer.MAX_NAME_LENGTH + " characters.", { name: name }));
							}
						}
						return name;
					};
					DataSanitizer.sanitizeString = function (value) {
						if (value) {
							...
							if (value.toString().length > DataSanitizer.MAX_STRING_LENGTH) {
								...
								ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("string value is too long. It has been truncated to " + DataSanitizer.MAX_STRING_LENGTH + " characters.", { value: value }));
							}
						}
						return value;
					};
					DataSanitizer.sanitizeUrl = function (url) {
						if (url) {
							if (url.length > DataSanitizer.MAX_URL_LENGTH) {
								...
								ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("url is too long, it has been trucated to " + DataSanitizer.MAX_URL_LENGTH + " characters.", { url: url }));
							}
						}
						return url;
					};
					DataSanitizer.sanitizeMessage = function (message) {
						if (message) {
							if (message.length > DataSanitizer.MAX_MESSAGE_LENGTH) {
								...
								ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("message is too long, it has been trucated to " + DataSanitizer.MAX_MESSAGE_LENGTH + " characters.", { message: message }));
							}
						}
						return message;
					};
					DataSanitizer.sanitizeException = function (exception) {
						if (exception) {
							if (exception.length > DataSanitizer.MAX_EXCEPTION_LENGTH) {
								...
								ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("exception is too long, it has been trucated to " + DataSanitizer.MAX_EXCEPTION_LENGTH + " characters.", { exception: exception }));
							}
						}
						return exception;
					};
			...
			var PageViewPerformance = (function (_super) {
				...
				function PageViewPerformance(name, url, unused, properties, measurements) {
					...
					if (timing) {
						...
						if (total == 0) {
							ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("error calculating page view performance.", { total: total, network: network, request: request, response: response, dom: dom }));
						}
						else if (total < Math.floor(network) + Math.floor(request) + Math.floor(response) + Math.floor(dom)) {
							ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("client performance math error.", { total: total, network: network, request: request, response: response, dom: dom }));
						}
						else {
	...
	(function (ApplicationInsights) {
		...
		var TelemetryContext = (function () {
			...
			TelemetryContext.prototype.track = function (envelope) {
				if (!envelope) {
					ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("cannot call .track() with a null or undefined argument"));
				}
				else {
			...
			TelemetryContext.prototype._track = function (envelope) {
				...
				if (!doNotSendItem) {
					if (envelope.name === ApplicationInsights.Telemetry.SessionTelemetry.envelopeType ||
						...
						ApplicationInsights._InternalLogging.logInternalMessage(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("Telemetry is sampled and not sent to the AI service.", { SampleRate: this.sample.sampleRate }));
					}
				}
				return envelope;
			};
				...
				PageViewManager.prototype.trackPageView = function (name, url, properties, measurements, duration) {
					...
					var handle = setInterval(function () {
						try {
							...
							ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("trackPageView failed on page load calculation: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
						}
					}, 100);
				};
...
(function (Microsoft) {
	...
	(function (ApplicationInsights) {
		"use strict";
		ApplicationInsights.Version = "0.22.4";
		var AppInsights = (function () {
			...
			AppInsights.prototype.startTrackPage = function (name) {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("startTrackPage failed, page view may not be collected: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			AppInsights.prototype.stopTrackPage = function (name, url, properties, measurements) {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("stopTrackPage failed, page view will not be collected: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			AppInsights.prototype.trackPageView = function (name, url, properties, measurements, duration) {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("trackPageView failed, page view will not be collected: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			AppInsights.prototype.startTrackEvent = function (name) {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("startTrackEvent failed, event will not be collected: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			AppInsights.prototype.stopTrackEvent = function (name, properties, measurements) {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("stopTrackEvent failed, event will not be collected: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			AppInsights.prototype.trackEvent = function (name, properties, measurements) {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("trackEvent failed, event will not be collected: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			...
			AppInsights.prototype.trackException = function (exception, handledAt, properties, measurements) {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("trackException failed, exception will not be collected: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			AppInsights.prototype.trackMetric = function (name, average, sampleCount, min, max, properties) {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("trackMetric failed, metric will not be collected: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			AppInsights.prototype.trackTrace = function (message, properties) {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("trackTrace failed, trace will not be collected: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			...
			AppInsights.prototype.flush = function () {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage("flush failed, telemetry will not be collected: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			AppInsights.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("Setting auth user context failed. " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
			AppInsights.prototype.clearAuthenticatedUserContext = function () {
				try {
					...
					ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("Clearing auth user context failed. " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
				}
			};
		...
		var Timing = (function () {
			...
			Timing.prototype.start = function (name) {
				if (typeof this._events[name] !== "undefined") {
					ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("start was called more than once for this event without calling stop.", { name: this._name, key: name }));
				}
			...
			Timing.prototype.stop = function (name, url, properties, measurements) {
				...
				if (isNaN(start)) {
					ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage("stop was called without a corresponding start.", { name: this._name, key: name }));
				}
				else {
					var end = +new Date;
		...
		var Initialization = (function () {
			...
			Initialization.prototype.emptyQueue = function () {
				try {
					...
					var message = new ApplicationInsights._InternalLogMessage("Failed to send queued telemetry");
			...
			Initialization.prototype.addHousekeepingBeforeUnload = function (appInsightsInstance) {
				...
				if ('onbeforeunload' in window) {
					...
					if (!Microsoft.ApplicationInsights.Util.addEventHandler('beforeunload', performHousekeeping)) {
						Microsoft.ApplicationInsights._InternalLogging.throwInternalNonUserActionable(Microsoft.ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage('Could not add handler for beforeunload'));
					}
				}
			};
